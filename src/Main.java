    ...
    public class Main {
        ...
        public static void main(String[] args) {
            ...
            if (band1.spendMoney(2000.0)) {
                System.out.println(band1.getBandName() + " bought new equipment!");
            } else {
                System.out.println(band1.getBandName() + " doesn't have enough money!");
            }
            ...
            System.out.println("\n                      * * * * FAN SHOWDOWN * * * * *");
            if (band1.getFans() > band2.getFans()) {
                System.out.println(band1.getBandName() + " has more fans!");
            } else if (band2.getFans() > band1.getFans()) {
                System.out.println(band2.getBandName() + " has more fans!");
            } else {
